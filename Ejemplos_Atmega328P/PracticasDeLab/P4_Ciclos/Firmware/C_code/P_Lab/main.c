...
//-- Global Variables
uint8_t DISPLAY[5] = {0xF0, 0x60, 0xB0, 0xC0}; // Valores para los números 0 a 3 en cátodo común
int counter; // Variable del contador
